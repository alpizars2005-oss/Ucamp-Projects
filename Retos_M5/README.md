...
Esta carpeta documenta los retos del módulo final de **SCRUM** en UCAMP. A diferencia de los módulos anteriores, el foco principal está en aplicar un marco ágil a un caso de estudio real y mantener trazabilidad entre necesidades, roles, backlog, sprints e incrementos.
...
Esta semana no modifica código ejecutable ni dependencias, por lo que no requiere pruebas unitarias. La verificación consiste en comprobar que:

- la justificación no excede 200 palabras;
- el producto y su alcance son claros;
- los tres roles de Scrum están correctamente definidos; y
- la entrega editable/PDF conserva una presentación legible y profesional.
